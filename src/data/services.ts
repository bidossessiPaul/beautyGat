...
export interface ServiceBooster {
  title: string;
  description: string;
}
...
export interface ServiceData {
  slug: string;
  title: string;
  name?: string; // nom court utilisé dans les titres de section, ex: "Hydrafacial"
  ...
  boosters?: ServiceBooster[]; // optionnel — section "Les boosters [name]"
  pricing: {
    headline: string;
    note: string;
...
export const services: ServiceData[] = [
  // ─── SOINS VISAGE ────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      { title: "Nettoyage Vortex-Cleanse®", description: "Ouverture des pores et nettoyage en profondeur grâce à la technologie Vortex-Fusion® pour éliminer les impuretés et l'excès de sébum." },
      { title: "Exfoliation & extraction", description: "Exfoliation chimique douce associée à une aspiration des points noirs et impuretés, sans douleur ni rougeurs." },
      { title: "Infusion de sérums actifs", description: "Diffusion de sérums hydratants, antioxydants et peptides directement dans les pores ouverts pour une efficacité maximale." },
      { title: "Protection & éclat", description: "Application d'une protection SPF et finalisation du soin pour une peau immédiatement lumineuse, rebondie et protégée." },
    ],
    forWho: {
      targets: [
        "Peaux mates avec irrégularités de teint ou taches",
        "Peaux grasses, mixtes et à pores dilatés",
        "Peaux déshydratées sous le climat chaud de Cotonou",
        "Peaux sensibles cherchant une exfoliation sans irritation",
        "Femmes et hommes dès 18 ans, tous phototypes",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    metaDescription: "Soin visage express homme à Cotonou Cadjehoun. Nettoyage et hydratation masculine 30 min. Academy Beauty Gate — 6 000 FCFA.",
    category: "visage",
    hero: {
    ...
    intro: {
      imageAlt: "Soin visage masculin Bénin",
...
const RELATED_CATEGORIES: Partial<Record<ServiceData["category"], ServiceData["category"][]>> = {
  ...
  "duo-enfants": ["mains-pieds", "massages", "privatisation"],
  privatisation: ["massages", "mains-pieds", "duo-enfants"],
};
