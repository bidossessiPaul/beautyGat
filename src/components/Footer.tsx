        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex gap-3">
            <Link
              ...
              className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center hover:bg-[#96000F] hover:border-[#96000F] transition-all"
            >
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex gap-3">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4 shrink-0 mt-0.5 text-[#96000F]">
          ...
          <Link
            href="#contact"
            className="group relative overflow-hidden inline-block mt-8 bg-[#96000F] text-white text-[12px] font-semibold uppercase tracking-widest px-6 py-3.5 rounded-[3px]"
          >
