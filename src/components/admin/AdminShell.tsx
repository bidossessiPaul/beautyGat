...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#f4f5f7] flex">
      {/* Sidebar */}
      <aside className="w-[220px] bg-[#1a1a1a] flex flex-col shrink-0 fixed top-0 left-0 h-screen z-40">
        {/* Logo */}
          ...
          <form action="/api/admin/logout" method="POST">
            ...
            >
              <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                <path
                  fillRule="evenodd"
                  d="M3 3a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h7a1 1 0 1 0 0-2H4V5h6a1 1 0 1 0 0-2H3zm11.707 4.293a1 1 0 0 1 0 1.414L13.414 10l1.293 1.293a1 1 0 0 1-1.414 1.414l-2-2a1 1 0 0 1 0-1.414l2-2a1 1 0 0 1 1.414 0z"
                  clipRule="evenodd"
                />
      ...
      {/* Content */}
      <div className="flex-1 min-w-0 ml-[220px]">{children}</div>
    </div>
  );
}
