...
export function ReviewsSection() {
  return (
    <section className="py-[60px] bg-[#6D071A] overflow-hidden">
      <div className="max-w-[1300px] mx-auto px-6 md:px-10 mb-10 text-center">
        <p className="text-[12px] font-bold uppercase tracking-[3px] text-[#f0b8b8] mb-3">
          Avis clients
        </p>
        <h2 className="font-sans text-[30px] md:text-[42px] font-bold text-white mb-3">
        ...
        <div className="flex items-center justify-center gap-2 mt-2">
          ...
          <span className="text-[13px] text-white/60">· 175+ avis Google</span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 relative">
        ...
        {/* Dégradés latéraux */}
        <div className="pointer-events-none absolute inset-y-0 left-0 w-24 z-10 bg-gradient-to-r from-[#6D071A] to-transparent" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-24 z-10 bg-gradient-to-l from-[#6D071A] to-transparent" />
