...
const MEGA_MENU = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Drainage lymphatique", href: "/soins/drainage-lymphatique-cotonou" },
      { label: "Cryolipolyse", href: "/soins/cryolipolyse-cotonou" },
      { label: "Gommage corps", href: "/soins/gommage-corps-cotonou" },
      { label: "Enveloppement corps", href: "/soins/enveloppement-corps-cotonou" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Nail art", href: "/soins/nail-art-cotonou" },
      ...
      { label: "Pédicure médicale", href: "/soins/pedicure-medicale-cotonou" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Barber shop", href: "/soins/coupe-barbe-cotonou" },
    ],
  },
];
