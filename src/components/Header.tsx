    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Épilation demi-jambes", href: "/menu" },
          { label: "Maillot brésilien", href: "/menu" },
          { label: "Vajacial", href: "/menu" },
          { label: "Massage relaxant corps entier", href: "/menu" },
          { label: "Massage aux pierres chaudes", href: "/menu" },
          { label: "Massage signature L.A Beauty", href: "/menu" },
        ],
      },
      {
        title: "👑 Coiffure, Maquillage & Beauté",
        links: [
          { label: "Braids / Knotless", href: "/menu" },
          { label: "Shampoing + Brushing", href: "/menu" },
          { label: "Make-up SOIR", href: "/menu" },
          { label: "Microblading sourcils", href: "/menu" },
          { label: "Manucure semi-permanent", href: "/menu" },
          { label: "Gel sur ongles naturels", href: "/menu" },
          { label: "Espace Duo & Enfants", href: "/menu" },
        ],
      },
    ],
  },
